...
angular.module('clientApp').factory('d3', [function () {
    var d3;
...
angular.module('clientApp').directive('wordcloud', [
  'd3',
  function (d3) {
    return {
      restrict: 'E',
      ...
      link: function postLink(scope, element, attrs) {
        ...
        var words;
        var width, height, fontFamily, fontSize;
        var id;
        ...
        var cloudFactory = function (words) {
          ...
          d3.layout.cloud().size([
            ...
            return {
              text: d,
              size: (Math.random() * (fontSize - 12)) + 12
            };
          })).rotate(function () {
